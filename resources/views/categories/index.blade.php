...
@section('content')
    ...
    <div class="row g-4"> @foreach($categories as $category)
        <div class="col-md-3 col-sm-6">
            <div class="card category-card shadow border-0 h-100 py-3"> <div class="card-body text-center d-flex flex-column justify-content-center">
                    ...
                    <div class="mb-3">
                        <span class="badge {{ $category->type == 'income' ? 'bg-success' : 'bg-danger' }} rounded-pill px-3">
